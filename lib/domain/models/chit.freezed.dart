...
/// moment of every edit after that (ADR-014).
 DateTime get updatedAt;/// What the chit says. `null` on a chit that is only a recording —
/// BEHAVIOUR.md §3.4.
 String? get text;/// The recording, relative to the app documents directory (ADR-008).
