...
mixin _$ComposerState {
  ...
  $ComposerStateCopyWith<ComposerState> get copyWith =>
      _$ComposerStateCopyWithImpl<ComposerState>(
        this as ComposerState,
        _$identity,
      );
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.stamp, _this.stamp) ||
                other.stamp == _this.stamp) &&
            (identical(other.text, _this.text) || other.text == _this.text) &&
            (identical(other.showPrompt, _this.showPrompt) ||
                other.showPrompt == _this.showPrompt) &&
            (identical(other.audioTempPath, _this.audioTempPath) ||
                other.audioTempPath == _this.audioTempPath) &&
            (identical(other.audioDuration, _this.audioDuration) ||
                other.audioDuration == _this.audioDuration) &&
            (identical(other.isRecording, _this.isRecording) ||
                other.isRecording == _this.isRecording) &&
...
abstract mixin class $ComposerStateCopyWith<$Res> {
  factory $ComposerStateCopyWith(
    ComposerState value,
    $Res Function(ComposerState) _then,
  ) = _$ComposerStateCopyWithImpl;
  @useResult
  $Res call({
    AmbientStamp stamp,
    String text,
...
class _$ComposerStateCopyWithImpl<$Res>
  ...
  $Res call({
    Object? stamp = null,
    Object? text = null,
    Object? showPrompt = null,
    Object? audioTempPath = freezed,
    ...
    return _then(
      ComposerState(
        stamp: null == stamp ? _self.stamp : stamp as AmbientStamp,
        text: null == text ? _self.text : text as String,
        showPrompt: null == showPrompt ? _self.showPrompt : showPrompt as bool,
        audioTempPath: freezed == audioTempPath
            ? _self.audioTempPath
            : audioTempPath as String?,
...
extension ComposerStatePatterns on ComposerState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ComposerState value)? $default, {
...
class _ComposerState extends ComposerState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ComposerStateCopyWith<_ComposerState> get copyWith =>
      __$ComposerStateCopyWithImpl<_ComposerState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ComposerState &&
            (identical(other.stamp, stamp) || other.stamp == stamp) &&
            (identical(other.text, text) || other.text == text) &&
            (identical(other.showPrompt, showPrompt) ||
                other.showPrompt == showPrompt) &&
            (identical(other.audioTempPath, audioTempPath) ||
                other.audioTempPath == audioTempPath) &&
...
abstract mixin class _$ComposerStateCopyWith<$Res>
    implements $ComposerStateCopyWith<$Res> {
  factory _$ComposerStateCopyWith(
    _ComposerState value,
    $Res Function(_ComposerState) _then,
  ) = __$ComposerStateCopyWithImpl;
  @override
  @useResult
  $Res call({
    AmbientStamp stamp,
