...
/// writes into it once and never again (BEHAVIOUR.md §3.4.1).
 ...
 TextOrigin? get textOrigin;/// Set once a recording is kept, and cleared only by Discard. **M5.**
...
int get hashCode {
  final _this = this as ComposerState;
  return Object.hash(runtimeType,_this.stamp,_this.text,_this.textOrigin,_this.audioTempPath,_this.audioDuration,_this.isRecording,_this.sttFailed);
}

@override
String toString() {
  final _this = this as ComposerState;
  return 'ComposerState(stamp: ${_this.stamp}, text: ${_this.text}, textOrigin: ${_this.textOrigin}, audioTempPath: ${_this.audioTempPath}, audioDuration: ${_this.audioDuration}, isRecording: ${_this.isRecording}, sttFailed: ${_this.sttFailed})';
}
...
@useResult
$Res call({
 AmbientStamp stamp, String text, TextOrigin? textOrigin, String? audioTempPath, Duration? audioDuration, bool isRecording, bool sttFailed
});
...
/// Create a copy of ComposerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? stamp = null,Object? text = null,Object? textOrigin = freezed,Object? audioTempPath = freezed,Object? audioDuration = freezed,Object? isRecording = null,Object? sttFailed = null,}) {
...
as TextOrigin?,audioTempPath: freezed == audioTempPath ? _self.audioTempPath : audioTempPath // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AmbientStamp stamp,  String text,  TextOrigin? textOrigin,  String? audioTempPath,  Duration? audioDuration,  bool isRecording,  bool sttFailed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ComposerState() when $default != null:
return $default(_that.stamp,_that.text,_that.textOrigin,_that.audioTempPath,_that.audioDuration,_that.isRecording,_that.sttFailed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AmbientStamp stamp,  String text,  TextOrigin? textOrigin,  String? audioTempPath,  Duration? audioDuration,  bool isRecording,  bool sttFailed)  $default,) {final _that = this;
switch (_that) {
case _ComposerState():
return $default(_that.stamp,_that.text,_that.textOrigin,_that.audioTempPath,_that.audioDuration,_that.isRecording,_that.sttFailed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AmbientStamp stamp,  String text,  TextOrigin? textOrigin,  String? audioTempPath,  Duration? audioDuration,  bool isRecording,  bool sttFailed)?  $default,) {final _that = this;
switch (_that) {
case _ComposerState() when $default != null:
return $default(_that.stamp,_that.text,_that.textOrigin,_that.audioTempPath,_that.audioDuration,_that.isRecording,_that.sttFailed);case _:
  return null;
...
class _ComposerState extends ComposerState {
  const _ComposerState({required this.stamp, this.text = '', this.textOrigin, this.audioTempPath, this.audioDuration, this.isRecording = false, this.sttFailed = false}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,stamp,text,textOrigin,audioTempPath,audioDuration,isRecording,sttFailed);
}

@override
String toString() {
    return 'ComposerState(stamp: $stamp, text: $text, textOrigin: $textOrigin, audioTempPath: $audioTempPath, audioDuration: $audioDuration, isRecording: $isRecording, sttFailed: $sttFailed)';
}
...
/// Create a copy of ComposerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? stamp = null,Object? text = null,Object? textOrigin = freezed,Object? audioTempPath = freezed,Object? audioDuration = freezed,Object? isRecording = null,Object? sttFailed = null,}) {
